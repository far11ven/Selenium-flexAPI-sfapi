...
package sfapi.commands
{
	...
	public class ClickCommands
	{
		...
		// TODO : comms
		public function myAccordionClick(id:String, tabLabel:String):String 
		{
			var child:Object = appTreeParser.getElement(id);
			...
			try{
				...
				result = clickAccordion(child, tabLabel);
				return result;
			}
			catch (error:Error)
			{
		...
		public function doFlexClickDataGridItem(id:String, value:String):String
		{
			...
			var result:String= "DAADSA";
			
			try{
				result = rawFlexClickDataGridItem(id, colIndex, itemText);
				return result;
			}
			catch (error:Error)
			{
