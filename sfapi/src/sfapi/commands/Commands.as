	...
	public class Commands
	{
		...
		public function Commands(aptObj:AppTreeParser)
		{
			...
			if(ExternalInterface.available)
			{
				...
				ExternalInterface.addCallback("getFlexDataGridCellElement", 
					dataGridCommands.getFlexDataGridCellElement);
				...
				ExternalInterface.addCallback("myAccordionClick", 
					clickCommands.myAccordionClick);
				...
				ExternalInterface.addCallback("doFlexSelectDataGridRow", 
					dataGridCommands.doFlexSelectDataGridRow);
				
				ExternalInterface.addCallback("getMyObjectType", 
					tools.getMyObjectType);
				
				ExternalInterface.addCallback("getIndexOf", 
					selectCommands.getIndexOf);
				
				ExternalInterface.addCallback("selectFlexTreeItem", 
					selectCommands.selectFlexTreeItem);
				
							
				ExternalInterface.addCallback("doFlexObjectCommands", 
					utilCommands.doFlexObjectCommands);
				
				ExternalInterface.addCallback("doFlexIDCommands", 
					utilCommands.doFlexIDCommands);
				// Raw commands
